<style>
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="nav-buttons d-none d-md-flex">
                ...
                <a href="customer_profile.php" class="user-icon"><i class="fas fa-user"></i></a>
            </div>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="customer_home.php"><i class="fas fa-home"></i>Home</a>
        <a href="store.php"><i class="fas fa-store"></i>Store</a>
        <a href="about_us.php"><i class="fas fa-info-circle"></i>About Us</a>
        <a href="customer_profile.php" class="user-icon"><i class="fas fa-user"></i>Account</a>
    </div>
