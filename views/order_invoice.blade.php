        ...
        <div class="invoice-wrapper">
            ...
            <div class="invoice-details">
                <table class="no-lines equal-width">
                    <tr>
                        <td>
                            <span style="font-size: 30px; font-weight: bold;">Order No: {{ $orderDetails->order_id }}</span><br>
                            <span>Invoice No: {{ $orderDetails->invoice_id }}</span>
                        </td>
                        <td>
                ...
                <tr>
                    <td class="invoice-single-details">
                        ...
                        <ul class="details-list">
                            <li class="list">{{ $orderDetails->reseller_name }}</li>
                            <li class="list">{{ $orderDetails->user_email }}</li>
                        </ul>
                    </td>
                    <td class="invoice-single-details">
            ...
            <table class="custom--table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $orderDetails->order_total_amount }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
