    ...
    <div class="invoice-area">
        <div class="invoice-wrapper">
            ...
            <div class="invoice-details">
                <table class="no-lines equal-width">
                    <tr>
                        <td>
                            <span style="font-size: 30px; font-weight: bold;">Order No: {{ $orderCustomerDetails->order_id }}</span><br>
                            <span>Invoice No: {{ $orderCustomerDetails->invoice_id }}</span>
                        </td>
                        <td>
                            <span>Invoice Date: {{ now()->format('F j, Y') }}</span><br>
                ...
                <tr>
                    <td class="invoice-single-details">
                        ...
                        <ul class="details-list">
                            <li class="list">{{ $orderCustomerDetails->reseller_name }}</li>
                            <li class="list">{{ $orderCustomerDetails->user_email }}</li>
                        </ul>
                    </td>
                    <td class="invoice-single-details">
        ...
        <div class="item-description">
            <table class="custom--table">
                ...
                <tbody>
                    @foreach ($orderCustomerDetails->items as $index => $item)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                    ...
                    <tr>
                        ...
                        <td>{{ $orderCustomerDetails->order_total_amount }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
