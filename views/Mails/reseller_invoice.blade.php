    ...
    <div class="invoice-area">
        <div class="invoice-wrapper">
            ...
            <div class="invoice-details">
                <table class="no-lines equal-width">
                    <tr>
                        <td>
                            <span style="font-size: 30px; font-weight: bold;">Order No: {{ $orderResellerDetails->order_id }}</span><br>
                            <span>Invoice No: {{ $orderResellerDetails->invoice_id }}</span>
                        </td>
                        <td>
                ...
                <tr>
                    <td class="invoice-single-details">
                        ...
                        <ul class="details-list">
                            <li class="list">{{ $orderResellerDetails->reseller_name }}</li>
                            <li class="list">{{ $orderResellerDetails->user_email }}</li>
                        </ul>
                    </td>
                    <td class="invoice-single-details">
        ...
        <div class="item-description">
            <table class="custom--table">
                ...
                <tbody>
                    @foreach ($orderResellerDetails->items as $index => $item)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                    ...
                    <tr>
                        ...
                        <td>{{ $orderResellerDetails->order_total_amount }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
