...
<div class="content-wrapper">
    <div class="red-background">
        <div class="column" data-aos="fade-right">
            <img class="home-logo" src="{{ asset('assets/home_logo.png') }}" alt="Logos">
            <h3>DELICIOUS, HOT AND FRESH</h3>
            <p>Craving a pizza slice of happiness? <br> Place your order now!</p>
            <div class="buttons-container">
                <a href="{{ route('customer.register') }}"><button>Register</button></a>
                <a href="{{ route('login') }}"><button>Login</button></a>
            </div>
        </div>
        <div class="column" data-aos="fade-left">
            <img class="pizza-background" src="{{ asset('assets/pizza_bg.png') }}" alt="Pizzas">
        </div>
    </div>
                ...
                @else
                    @foreach ($resellers as $reseller)
                        <div class="store-list">
                            <h3>{{ $reseller->store_name }}</h3>
                            <h2>Address:</h2>
                            <p>{{ $reseller->store_street }}, {{ $reseller->store_barangay }}, {{ $reseller->store_city}}, {{ $reseller->store_province}}</p>      
                            <h2>Contact Number:</h2>
                            <p>{{ $reseller->reseller_number }}</p>
                            <div class="view-map-button">
                                <button onclick="openModal('modal-{{ $reseller->reseller_id }}')">View Map</button>
                            </div>
                            <div id="modal-{{ $reseller->reseller_id }}" class="modal">
                                <div class="modal-content">
                                    <span class="close" onclick="closeModal('modal-{{ $reseller->reseller_id }}')">&times;</span>
                                    <iframe class="map-iframe" src="{{ $reseller->store_map }}" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    @endforeach
