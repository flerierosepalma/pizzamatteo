...
<body>
    ...
    <div class="content-wrapper">
        <div class="main-content bg">
            <div class="container-form">
                ...
                <form method="POST" action="{{ route('login.verification.post') }}">
                    @csrf
                    ...
                    <p class="resend-otp"><a
                            href="{{ route('login.verification.resendOtp', ['email' => request('email')]) }}">Resend
                            OTP</a></p>
    ...
    <script>
        document.getElementById('resendOtp').addEventListener('click', function(event) {
            ...
            fetch('{{ route('login.verification.resendOtp') }}', {
                    method: 'POST',
                    headers: {
