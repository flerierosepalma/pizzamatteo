        ...
        <div class="main-content bg">
            <div class="container-form">
                ...
                <form action="{{ route('customer.register.post') }}" method="POST">
                    ...
                    <p class="text-center mb-0">Already have an account? <a href="{{ route('login') }}"
    ...
    <script>
        ...
        function updateStores() {
            ...
            @foreach ($store as $store)
                if ("{{ $store->store_province }}" === province) {
                    addOption(storeSelect, "{{ $store->store_name }}", "{{ $store->reseller_id }}");
                }
            @endforeach
        }
