    ...
    <div class="invoice-area">
        <div class="invoice-wrapper">
            ...
            <div class="invoice-details">
                <table class="no-lines equal-width">
                    <tr>
                        <td>
                            <span style="font-size: 30px; font-weight: bold;">Order No: <?php echo e($orderDetails->order_id); ?></span><br>
                            <span>Invoice No: <?php echo e($orderDetails->invoice_id); ?></span>
                        </td>
                        <td>
                ...
                <tr>
                    <td class="invoice-single-details">
                        ...
                        <ul class="details-list">
                            <li class="list"><?php echo e($orderDetails->reseller_name); ?></li>
                            <li class="list"><?php echo e($orderDetails->user_email); ?></li>
                        </ul>
                    </td>
                    <td class="invoice-single-details">
        ...
        <div class="item-description">
            <table class="custom--table">
                ...
                <tbody>
                    <?php $__currentLoopData = $orderDetails->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($orderDetails->order_total_amount); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/order_invoice.blade.php ENDPATH**/ ?>