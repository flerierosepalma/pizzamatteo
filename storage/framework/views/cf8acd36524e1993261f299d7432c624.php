...
<body>
        ...
        <ul class="sidebar-list">
            ...
            <li class="dropdown">
                ...
                <div class="submenu">
                    ...
                    <a href="reseller-invoice.php" class="link">Invoices</a>
                </div>
            </li>
            ...
            <li class="dropdown">
                ...
                <div class="submenu">
                    ...
                    <a href="reseller-date-visibility.php" class="link">Data Visibility</a>
            ...
            <li>
                <div class="title">
                    <a href="reseller-generate.php" class="link">
                ...
                <div class="submenu">
                    <a href="reseller-generate.php" class="link submenu-title">Generate Report</a>
                    <!-- submenu links here  -->
                </div>
            </li>
        </ul>
    ...
    <section class="home">
        ...
        <div class="top">
            ...
            <span class="page-title">Data Visibility</span>
        ...
        <div class="content">
            ...
            <div class="data-grid">
                <div class="data-box large">
                    <h2>ONHAND STOCKS</h2>
                    <canvas id="onhandStocksChart"></canvas>
                    <!-- content -->
                </div>
                <div class="data-box large">
                ...
                <div class="data-box small">
                    <h2>LOW STOCK RATE</h2>
                    <!-- content -->
                </div>
                <div class="data-box medium">
                    <h2>PRODUCTS SOLD WITHIN FRESHNESS DATE</h2>
                    <!-- content -->
                </div>
                <div class="data-box small">
                    <h2>OUT OF STOCK RATE</h2>
                    <!-- content -->
                </div>
                <div class="data-box medium">
                    <h2>STOCK LEVELS OVERTIME</h2>
                    <!-- content -->
                </div>
                <div class="data-box small">
                    <h2>EXPIRED STOCK RATE</h2>
                    <!-- content -->
                </div>
                <div class="data-box small">
                    <h2>TURNOVER RATE</h2>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            var ctx = document.getElementById('onhandStocksChart').getContext('2d');
            var onhandStocksChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: [
                        'Arabic Shawarma',
                    ...
                    datasets: [{
                        label: 'Onhand Stocks',
                        data: [20, 15, 10, 25, 30, 5, 10, 20, 10, 15, 20],
...
</html><?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/reseller_data_visibility.blade.php ENDPATH**/ ?>