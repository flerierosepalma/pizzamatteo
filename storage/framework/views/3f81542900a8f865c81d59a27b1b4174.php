...
<head>
    ...
    <title>Pizza Matteo | Forgot Password</title>
    ...
    <div class="content-wrapper">
        <div class="main-content bg">
            <div class="container-form">
                ...
                <p class="text-center text-muted mb-2">Please enter your email address to receive a verification code.
                </p>
                <form method="POST" action="<?php echo e(route('forgot.passoword.sent.otp')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/forgot_password.blade.php ENDPATH**/ ?>