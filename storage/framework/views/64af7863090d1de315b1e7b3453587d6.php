...
<head>
    ...
    <style>
        ...
        * {
        ...
        .content-header .pickup-toggle.active {
            color: black;
...
<body>
   ...
   <section class="home">
    <div class="top">
            ...
            <span class="page-title">Active Orders</span>
        ...
        <div class="content">
            <div class="content-header">
                <div class="left-header">
                    ...
                    <button onclick="showContent(3)" class="pickup-toggle toggle-3">For Pickup</button>
                ...
                <?php $__currentLoopData = $customerOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($order->order_status === 'pending'): ?>
                        <tr>
                            ...
                            <td><?php echo e($order->purchase_type); ?></td>
                            <td>
                                <button class="btn-summary" onclick="showSummaryModal('<?php echo e($order->order_id); ?>')">See Order</button>
                            </td>
                            <td>
                                <button class="btn-proof" onclick="showPaymentProofModal('<?php echo e(asset('storage/' . $order->payment_proof)); ?>', '<?php echo e($order->gcash_name); ?>', '<?php echo e($order->gcash_number); ?>', '<?php echo e($order->amount_paid); ?>')">View Proof</button>

                            <td><?php echo e($order->order_timestamp); ?></td>
                            <td><?php echo e($order->order_expected_completion); ?></td>
                            <td>
    ...
    <table>
        ...
        <tbody id="table-1-body">
            ...
            <tr>
                ...
                <td><?php echo e($order->customer_name); ?></td>
                <td><?php echo e($order->purchase_type); ?></td>
                <td><button class="btn-summary" onclick="showSummaryModal('<?php echo e($order->order_id); ?>')">See Order</button></td>
                <td><button class="btn-proof" onclick="showPaymentProofModal('<?php echo e(asset('storage/' . $order->payment_proof)); ?>', '<?php echo e($order->gcash_name); ?>', '<?php echo e($order->gcash_number); ?>', '<?php echo e($order->amount_paid); ?>')">View Proof</button></td>
                <td><?php echo e($order->order_timestamp); ?></td>
                <td><?php echo e($order->order_expected_completion); ?></td>
                <td>
                    <button class="btn-pickup" data-order-id="<?php echo e($order->order_id); ?>">Pickup</button>
                </td>
            </tr>
            <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
 ...
 <!-- ============= COMPLETED =============== -->
        <div id="content-3" class="clickers" style="display: none;">
            <table>
                ...
                <tbody id="table-2-body">
                    <?php $__currentLoopData = $customerOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($order->order_status === 'Ready for pickup'): ?>
                        <tr>
                            <td><?php echo e($order->order_id); ?></td>
                            <td><?php echo e($order->customer_name); ?></td>
                            <td><?php echo e($order->purchase_type); ?></td>
                            ...
                            <td><?php echo e($order->order_expected_completion); ?></td>
                            <td>
                                <button class="btn-cancel" data-order-id="<?php echo e($order->order_id); ?>">Refund Report</button>
                            </td>
                        </tr>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="paymentProofModal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <p id="gcashName">GCash Name: </p>
            <p id="gcashNumber">GCash Number: </p>
            <p id="amountPaid">Amount Paid: </p>
        </div>
    </div>
...
function showPaymentProofModal(imageSrc, gcashName, gcashNumber, amountPaid) {
    var modal = document.getElementById("paymentProofModal");
    var modalImg = document.getElementById("paymentProofImage");
    var modalGcashName = document.getElementById("gcashName");
    var modalGcashNumber = document.getElementById("gcashNumber");
    var modalAmountPaid = document.getElementById("amountPaid");

    modalImg.src = imageSrc;
    modalGcashName.textContent = "GCash Name: " + gcashName;
    modalGcashNumber.textContent = "GCash Number: " + gcashNumber;
    modalAmountPaid.textContent = "Amount Paid: " + amountPaid;
...
function showSummaryModal(orderId) {
    $.ajax({
        url: '<?php echo e(route("customer.order.summary")); ?>',
        type: 'GET',
...
function showContent(contentId) {
    ...
    const buttons = document.querySelectorAll(".pending-toggle, .preparing-toggle, .pickup-toggle"); // Corrected the selector

    buttons.forEach(button => button.classList.remove("active"));
    // Hide or show content based on contentId
...
</html><?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/reseller_active_orders.blade.php ENDPATH**/ ?>