...
<body>
    <header class="header">
        <a href="<?php echo e(route('customer.register')); ?>" class="back-button">
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/customer_register_verification.blade.php ENDPATH**/ ?>