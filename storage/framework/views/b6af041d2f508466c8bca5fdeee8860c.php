        ...
        <div class="main-content bg">
            <div class="container-form">
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <p class="forgot-password"><a href="<?php echo e(route('forgot.password')); ?>">Forgot password?</a></p>
                    <button type="submit" class="btn btn-custom btn-block">LOGIN</button>
                    <div class="divider">or</div>
                    <p class="text-center mb-0">Don’t have an account? <a href="<?php echo e(route('customer.register')); ?>"
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/login.blade.php ENDPATH**/ ?>