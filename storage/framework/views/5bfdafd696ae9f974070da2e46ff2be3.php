                ...
                <?php $__currentLoopData = $stocksForMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td data-label="Days to Expiry">
                            <span style= "font-weight: bold; color: <?php echo e($expiryTextColor); ?>;">
                        ...
                        <td>
                            <button type="button" onclick="showDisposeModal(<?php echo e(json_encode($menu)); ?>, <?php echo e(json_encode($stock)); ?>)" class="btn-dispose <?php echo e($isExpired ? 'btn-red' : 'btn-orange'); ?>">Dispose</button>
        ...
        <table>
            ...
            <tbody id="table-2-body">
                <?php $__currentLoopData = $stockLog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td>#<?php echo e($stock->stock_item_id); ?></td>
                        <td><?php echo e($stock->menu_name); ?></td>
                        <td>₱<?php echo e($stock->menu_base_price); ?></td>
                        <td><?php echo e($stock->total_stock); ?></td>
                        <td>₱<?php echo e($stock->menu_base_price * $stock->total_stock); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($stock->stock_date)->format('F d, Y')); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($stock->expiry_date)->format('F d, Y')); ?></td>
                        <td><?php echo e($stock->disposed_stock); ?></td>
                        <td>
                            <button type="button" class="btn-edit" onclick="showEditStockModal(<?php echo e(json_encode($stock)); ?>)">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form id="deleteForm" action="<?php echo e(route('owner.delete.stock',  $stock->stock_item_id)); ?>" method="POST" style="display:inline;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="button" class="btn-delete" onclick="showDeleteModal('<?php echo e(route('owner.delete.stock',  $stock->stock_item_id)); ?>')">
                    ...
                    <tbody id="table-3-body">
                        <?php $__currentLoopData = $stockTransfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(\Carbon\Carbon::parse($transfer->transfer_date)->format('F j, Y, g:i A')); ?></td>
                ...
                <table>
                    ...
                    <tbody id="table-4-body">
                        ...
                        <tr>
                            ...
                            <td><?php echo e(\Carbon\Carbon::parse($log->old_expiry_date)->format('F d, Y')); ?></td>
                            <td><?php echo e(\Carbon\Carbon::parse($log->new_expiry_date)->format('F d, Y')); ?></td>
                            <td><?php echo e($log->update_action); ?></td>
                            <td><?php echo e(\Carbon\Carbon::parse($log->updated_at)->format('F j, Y, g:i A')); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<!-- ============= ADD STOCK MODAL =============== --> 
    ...
    <div id="disposeModal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <h2>Dispose Stock</h2>
            <form id="disposeStockForm" method="POST" enctype="multipart/form-data" action="<?php echo e(route('dispose.owner.stock')); ?>">
                <?php echo csrf_field(); ?>
...
<div class="modal" id="editStockModal" style="display: none;">
    <div class="modal-content">
        ...
        <h2>EDIT STOCK</h2>
        <form id="editProductForm" method="POST" enctype="multipart/form-data" action="<?php echo e(route('owner.update.stock')); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/owner_inventory.blade.php ENDPATH**/ ?>