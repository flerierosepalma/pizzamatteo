...
<body>
    ...
    <section class="home">
        ...
        <div class="top"> 
            ...
            <span class="page-title">Forecasting: Reseller</span>
        </div>
    ...
    <div class="content">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <?php
                                ...
                                sort($sortedMenuIds);
                            ?>
                            <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th><?php echo e($menuNames[$menuId]); ?></th>
                    ...
                    <tbody>
                            <?php $__currentLoopData = $weeklyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($week['date_range']); ?></td>
                                    <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr style="background-color: #a6a6a6;">
                                    ...
                                    <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <td style="font-weight: bold;"><?php echo e($roundedForecast); ?></td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
                            </tbody>
                            </table>
            ...
            <div id="content-2" class="clickers" style="display: none;">
                <div class="scroll-buttons-container">
                    ...
                    <tbody>
                            <?php $__currentLoopData = $monthlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monthlyDatum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($monthlyDatum['date_range']); ?></td>
                                    <?php $__currentLoopData = $monthlyDatum['menu_quantities']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId => $quantity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td><?php echo e($quantity); ?></td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="content-3" class="clickers" style="display: none;">
                <div class="scroll-buttons-container">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $quarterlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quarter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($quarter['date_range']); ?></td>
                            <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    // Access quantity for the current menuId (or set to 0 if missing)
            ...
            <div id="content-4" class="clickers" style="display: none;">
                <div class="scroll-buttons-container">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $yearlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($year['date_range']); ?></td>
                            <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    // Access quantity for the current menuId (or set to 0 if missing)
...
const weeklyChartData = {
    ...
    datasets: [
        ...
        <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                label: '<?php echo e($menuNames[$menuId]); ?>',
                data: [
                    <?php $__currentLoopData = $weeklyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e(isset($week['menu_quantities'][$menuId]) ? $week['menu_quantities'][$menuId] : 0); ?>,
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    // calculate forecasted data for this menu
                    <?php
                        $quantities = array_slice(array_reverse($weeklyData), 0, 3);
                        $sum = 0;
                        foreach ($quantities as $quantity) {
                            $sum += isset($quantity['menu_quantities'][$menuId]) ? $quantity['menu_quantities'][$menuId] : 0;
                        }

                        $forecast = $sum / 3;
                        $decimalPart = $forecast - floor($forecast);
                        $roundingThreshold = 0.5;
            ...
            <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                {
                    ...
                    data: [
                        <?php $__currentLoopData = $monthlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo e(isset($month['menu_quantities'][$menuId]) ? $month['menu_quantities'][$menuId] : 0); ?>,
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        // calculate forecasted data for this menu
                        <?php
                            $quantities = array_slice(array_reverse($monthlyData), 0, 3);
        ...
        <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                ...
                data: [
                    <?php $__currentLoopData = $quarterlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quarter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e(isset($quarter['menu_quantities'][$menuId]) ? $quarter['menu_quantities'][$menuId] : 0); ?>,
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    // calculate forecasted data for this menu
                    <?php
                        $quantities = array_slice(array_reverse($quarterlyData), 0, 3);
        ...
        <?php $__currentLoopData = $sortedMenuIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                ...
                data: [
                    <?php $__currentLoopData = $yearlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e(isset($year['menu_quantities'][$menuId]) ? $year['menu_quantities'][$menuId] : 0); ?>,
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    // calculate forecasted data for this menu
                    <?php
                        $quantities = array_slice(array_reverse($yearlyData), 0, 3);
...
</html><?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/reseller_forecasting.blade.php ENDPATH**/ ?>