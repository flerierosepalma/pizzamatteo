...
<body>
        ...
        <ul class="sidebar-list">
            <li class="dropdown">
                ...
                <div class="submenu">
                    ...
                    <a href="<?php echo e(url('reseller_active_orders')); ?>"class="link">Active Orders</a>
                    <a href="<?php echo e(url('reseller_order_history')); ?>"class="link">Order History</a>
            ...
            <li class="dropdown">
                ...
                <div class="submenu">
                    ...
                    <a href="<?php echo e(url('reseller_inventory')); ?>" class="link">Inventory Stock</a>
                    <a href="<?php echo e(url('reseller_restock_request')); ?>" class="link">Restock Request</a>
                    <a href="<?php echo e(url('reseller_data_visibility')); ?>" class="link">Data Visibility</a>
            ...
            <li>
                <div class="title">
                    <a href="<?php echo e(url('reseller_generate_report')); ?>" class="link">
    ...
    <section class="home">
        <div class="top">
            ...
            <button class="stock-request" onclick="showAddModal()" <?php echo e(!$isScheduledDay ? 'disabled' : ''); ?>>
                <?php echo e($isScheduledDay ? 'Request Stock' : 'Request Stock Schedule: ' . implode(', ', $requestSchedule)); ?>
    ...
    <div id="content-2" class="clickers" style="display: none;">
                    ...
                    <tbody id="table-3-body">
                        <?php $__currentLoopData = $completedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(\Carbon\Carbon::parse($order->order_timestamp)->format('F j, Y, g:i A')); ?></td>
                                <td>
                                    <button class="btn-summary" onclick="showSummaryModal('<?php echo e($order->order_id); ?>')">See Order Summary</button>
                                </td>
                                <td>
                                    <?php if($order->payment_proof): ?>
                                        <button class="btn-proof" onclick="showPaymentProofModal('<?php echo e(asset('storage/' . $order->payment_proof)); ?>')">View Proof</button>
        ...
        <div class="modal" id="stockRequestModal">
            <div class="modal-content">
                ...
                <h2>REQUEST STOCK</h2>
                <form id="stockOrderForm" action="<?php echo e(route('submit.stock.order')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<script>
 ...
 function showAddModal() {
        if (<?php echo e(json_encode($isScheduledDay)); ?>) {
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/reseller_restock_request.blade.php ENDPATH**/ ?>