...
<body>
    ...
    <div class="content-wrapper">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-8">
                        <div class="store-text">
                            Store: <span id="storeNames"><?php echo e($storeNames); ?></span>
                        ...
                        <div id="editForm" style="display: none;">
                            ...
                            <form id="storeForm" method="POST" action="<?php echo e(route('update.store')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <select class="form-control" id="updateStore" name="updateStore"
                                        onchange="removePlaceholderOption()">
                                        <option selected hidden value=""><?php echo e($storeNames); ?></option>
                                        <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resellerId => $storeName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($resellerId); ?>"><?php echo e($storeName); ?></option>
        ...
        <div class="pizza-menu <?php echo e($isOffline ? 'offline' : ''); ?>">
            <?php if($isOffline): ?>
                        ...
                        <?php if($menuStock > 0): ?>
                            <div class="menu-item">
                                <div class="menu-image-container">
                                    <img src="<?php echo e(asset('storage/menu/' . $menu->menu_picture)); ?>" alt="<?php echo e($menu->menu_name); ?>" class="menu-image">
                                </div>
                                <div class="menu-details">
                                    <h3><?php echo e($menu->menu_name); ?></h3>
                                    <h1>₱<?php echo e(number_format($menu->menu_price, 2)); ?></h1>
                                    <p><?php echo e($menu->menu_description); ?></p>
                                    <button class="select-button" data-toggle="modal" data-target="#menuModal"
                                        data-id="<?php echo e($menu->menu_id); ?>" data-name="<?php echo e($menu->menu_name); ?>"
                                        data-description="<?php echo e($menu->menu_description); ?>"
                                        data-price="<?php echo e($menu->menu_price); ?>"
                                        data-image="<?php echo e(asset('storage/menu/' . $menu->menu_picture)); ?>">
                                        Select
                                    </button>
                                </div>
                            </div>
    ...
    $.ajax({
        type: "GET",
        url: "<?php echo e(route('stock.get')); ?>",
        data: {
            menu_id: id
        },
...
</html><?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/customer_home.blade.php ENDPATH**/ ?>