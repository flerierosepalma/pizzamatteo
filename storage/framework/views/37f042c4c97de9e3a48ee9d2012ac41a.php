    ...
    <div class="content-wrapper">
        <div class="main-content bg">
            <div class="container-form">
                ...
                <p class="text-center text-muted mb-4">Please enter the 6 digit code sent to <span style="color: #8A1C14; font-weight:bold;"></span></p>
                <form method="POST" action="<?php echo e(route('customer.register.verify.post')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/owner_register_verification.blade.php ENDPATH**/ ?>