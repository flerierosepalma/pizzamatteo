        ...
        <div class="container">
            <fieldset id="cart" class="active">
                <div class="fieldset-header">
                    <h2>My Cart (<?php echo e($cartItemCount); ?>)</h2>
                    <button class="clear-cart-button" onclick="clearCart()">Clear Cart</button>
                </div>
                <?php if($cartItemCount > 0): ?>
                    <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item">
                            <img src="<?php echo e(asset('storage/menu/' . $item->menu_picture)); ?>" alt="<?php echo e($item->menu_name); ?>">
                            <div class="item-info">
                                <h3><?php echo e($item->menu_name); ?></h3>
                                <div class="item-info-row">
                                    <p>Toast: <?php echo e($item->toast); ?></p>
                                    <p>Quantity: <?php echo e($item->quantity); ?></p>
                                </div>
                                <p class="amount">Total: ₱<?php echo e($item->quantity * $item->menu_price); ?></p>
                            </div>
                            <div class="item-actions">
                                <i class="fas fa-trash remove-icon" onclick="removeItem(<?php echo e($item->cart_item_id); ?>)"></i>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <div class="total">
                        <p class="total-amount">Order Total: ₱<?php echo e($totalAmount); ?></p>
                    </div>

                    <div class="button-group">
                        <button class="button button-back"
                            onclick="window.location.href='<?php echo e(route('back.customer.home')); ?>';">BACK</button>
            ...
            <fieldset id="checkout">
                ...
                <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item">
                        <div class="item-info">
                            <p><?php echo e($item->quantity); ?> - <?php echo e($item->menu_name); ?> [<?php echo e($item->toast); ?>]</p>
                            <p>₱<?php echo e($item->quantity * $item->menu_price); ?></p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <div class="total">
                ...
                <form method="POST" action="<?php echo e(route('place.order')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="additional-info">
                        <div class="column-left">
                            <p>Name: <b> <?php echo e($customer->customer_name); ?> </b></p>
                            <p>Email: <b> <?php echo e($customer->user_email); ?></b></p>
                            <p>Store: <b> <?php echo e($reseller->store_name); ?></b></p>
                            <p>Delivery Type: <b>Pick-up</b></p>
                            <p>Payment Method: <b>Gcash</b></p>
                            <p>Gcash Name: <b><?php echo e($reseller->store_gcash_name); ?> </b></p>
                            <p>Gcash Number: <b><?php echo e($reseller->store_gcash_number); ?> </b></p>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/customer_cart_checkout.blade.php ENDPATH**/ ?>