        ...
        <div class="main-content bg">
            <div class="container-form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <div class="input-group input-group-alternative">
                                ...
                                <input type="text" class="form-control" id="store" name="store" placeholder="Store Name" required>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <div class="input-group input-group-alternative">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="selectedDates" name="deliveryDate">
                </div>
                
                <div class="form-group">
                    <label for="pickupCalendar" class="form-label">Pick up Date</label>
                    <div id="pickupCalendar" class="weekly-calendar"></div>
                    <input type="hidden" id="selectedPickupDates" name="pickupDate">
                </div>
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/owner_register_reseller.blade.php ENDPATH**/ ?>