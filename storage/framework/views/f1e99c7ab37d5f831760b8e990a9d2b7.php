   ...
   <section class="home">
        ...
        <tbody>
            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>₱<?php echo e($menu->menu_price); ?></td>
                    <td>₱<?php echo e($menu->menu_base_price); ?></td>
                    <td><img class="menu-picture" src="<?php echo e(asset('storage/menu/' . $menu->menu_picture)); ?>" alt="Product Image" data-toggle="modal" data-target="#imageModal"></td>
                    <td><?php echo e($menu->menu_status); ?></td>
                    <td>
                        <button type="button" class="btn-edit" onclick="showEditModal(<?php echo e(json_encode($menu)); ?>)">
                            <i class="fas fa-edit"></i>
                        </button>
                        <?php if(!$menu->has_references): ?>
                        <form id="deleteForm" action="<?php echo e(route('delete.menu', $menu->menu_id)); ?>" method="POST" style="display:inline;">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="button" class="btn-delete" onclick="showDeleteModal('<?php echo e(route('delete.menu', $menu->menu_id)); ?>')">
    ...
    <div class="modal" id="addProductModal" style="display: none;">
        <div class="modal-content">
            ...
            <h2>ADD PRODUCT</h2>
            <form action="<?php echo e(route('add.menu')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
       ...
       <div class="modal" id="editProductModal" style="display: none;">
        <div class="modal-content">
            ...
            <h2>EDIT PRODUCT</h2>
            <form id="editProductForm" method="POST" enctype="multipart/form-data" action="<?php echo e(route('menu.update')); ?>">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/owner_menu.blade.php ENDPATH**/ ?>