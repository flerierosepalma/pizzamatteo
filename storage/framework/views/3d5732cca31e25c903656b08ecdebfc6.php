...
<div id="disposeModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <h2>Dispose Stock</h2>
        <form id="disposeStockForm" method="POST" enctype="multipart/form-data" action="<?php echo e(route('dispose.reseller.stock')); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/reseller_inventory.blade.php ENDPATH**/ ?>