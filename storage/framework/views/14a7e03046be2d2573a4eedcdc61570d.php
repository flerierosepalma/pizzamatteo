...
<head>
    ...
    <title>Pizza Matteo | Login Verification</title>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="main-content bg">
            <div class="container-form">
                ...
                <form method="POST" action="<?php echo e(route('login.verification.post')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <p class="resend-otp"><a
                            href="<?php echo e(route('login.verification.resendOtp', ['email' => request('email')])); ?>">Resend
                            OTP</a></p>
    ...
    <script>
        document.getElementById('resendOtp').addEventListener('click', function(event) {
            ...
            fetch('<?php echo e(route('login.verification.resendOtp')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\xampp\htdocs\pizzamatteo\resources\views/login_verification.blade.php ENDPATH**/ ?>